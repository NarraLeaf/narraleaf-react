...
import {default as StagePuppet} from "@player/elements/displayable/Puppet";
...
export default function Displayables(
    ...
    return (<>
        {displayable.map((displayable) => {
            ...
            } else if (displayable instanceof GamePuppet) {
                return <StagePuppet state={state} puppet={displayable} key={"puppet-" + displayable.getId()}/>;
            }
